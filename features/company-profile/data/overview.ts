...
export const companyProfile: CompanyProfile = {
  ...
  description:
    "Platform demo ini menempatkan company profile dan procurement dalam satu alur. Publik melihat kapabilitas kawasan dan portofolio, sementara tim internal menjalankan tender, evaluasi kontraktor, supplier history, dan tracking material.",
  highlights: [
    {
